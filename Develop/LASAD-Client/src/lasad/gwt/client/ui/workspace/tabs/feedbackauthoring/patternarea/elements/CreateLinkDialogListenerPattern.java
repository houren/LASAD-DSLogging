...
/**
 * Handles events on the create link dialog displayed on click and drag of a box's knob on the diagramming area
 * @author Anahuac
 *
 */
public class CreateLinkDialogListenerPattern extends
		AbstractCreateLinkDialogListener {

	public CreateLinkDialogListenerPattern(GraphMap map,
	...
	protected void onClickSendUpdateToServer(ElementInfo info, String mapId,
		...
		FeedbackAuthoringTabContent.getInstance().getPatternServerManager().
					createLinkWithElements(info, agentId, mapId, firstElemId, secondElemId);
