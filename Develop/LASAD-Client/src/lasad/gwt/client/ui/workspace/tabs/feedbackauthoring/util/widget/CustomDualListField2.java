...
public class CustomDualListField2<D extends ModelData> extends MultiField<Field<?>> {
	  ...
	  public static final int LEFT_BUTTON = 0x1;
	  public static final int RIGHT_BUTTON = 0x2;
...
//	  private boolean enableDND = true;
	  ...
	  public CustomDualListField2(List<Integer> buttonsToRemoveList) {
		this.buttonsToRemoveList= buttonsToRemoveList; 
	    fromField = new ListField<D>();
	    fromField.setStyleAttribute("color", "#000000");
...
//	    	  buttonBar.add(up);
	    ...
	    if(buttonsToRemoveList != null && !buttonsToRemoveList.contains(ALL_RIGHT_BUTTON)){
