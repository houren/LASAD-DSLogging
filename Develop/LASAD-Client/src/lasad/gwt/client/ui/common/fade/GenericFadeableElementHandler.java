 ...
 * @author Frank Loll, 
 */
public class GenericFadeableElementHandler {
	private AbstractGraphMap myMap;
	private AbstractMVController myController;
	...
	public GenericFadeableElementHandler(AbstractGraphMap abstractGraphMap) {
