...
public abstract class AbstractConnection extends Widget implements Connection {
	 ...
	 */
	private final List<Connector> connected = new ArrayList<Connector>();
	...
	/**
	 * @see lasad.gwt.client.helper.connection.Connection#remove()
	 */
	public void remove() {
...
//		removeFromParent();
	...
	/**
	 * @see lasad.gwt.client.helper.connection.Connection#disconnect(lasad.gwt.client.helper.connector.Connector)
	 */
	...
	/**
	 * @see lasad.gwt.client.helper.connection.Connection#update()
	 */
	public void update() {
		if (isAttached()) {
	...
	/**
	 * @see lasad.gwt.client.helper.connection.Connection#appendTo(com.google.gwt.user.client.ui.AbsolutePanel)
	 */
	...
	public void appendTo(ContentPanel panel) {
		panel.add(this);
		update();
	}
