...
public class BezierCurveVml extends BezierCurve {
	...
	public void draw(Point p1, Point p2, Point c1, Point c2) {
		...
		Point tmpPoint = new Point(20, 20);

		drawImpl(p1.move(start.negative()).move(tmpPoint), p2.move(start.negative()).move(tmpPoint), c1.move(start.negative()).move(tmpPoint), c2.move(start.negative()).move(tmpPoint));
	}
	...
	private void drawImpl(Point p1, Point p2, Point c1, Point c2) {
		...
		// DOM.setElementAttribute(vmlCurve, "control1", p1.left + "," +
		// p1.top);
		// DOM.setElementAttribute(vmlCurve, "control2", p2.left + "," +
		// p2.top);
